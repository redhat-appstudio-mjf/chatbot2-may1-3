...
The source code for your chosen application can be found in [https://github.com/redhat-appstudio-mjf/chatbot2-may1-3](https://github.com/redhat-appstudio-mjf/chatbot2-may1-3).

The GitOps repository, which contains the Kubernetes manifests for the application can be found in 
[https://github.com/redhat-appstudio-mjf/chatbot2-may1-3-gitops](https://github.com/redhat-appstudio-mjf/chatbot2-may1-3-gitops). 

# Deployment Information

You can find deployed resources from this template in the **chatbot2-may1-3** namespace.
